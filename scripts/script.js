...
popupListClose.forEach(handleClosePopup)

function handleClosePopup (btn){
btn.addEventListener('click', closePopup)
}

function closePopup(){
  popupList.forEach(findOpenPopup)
}

function findOpenPopup(window){
  window.classList.remove('popup_modal_is-opened')
}
